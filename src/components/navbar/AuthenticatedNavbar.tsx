...
const AuthenticatedNavbar: FC = (props) => {
    ...
    return (
        <div className={"fixed z-50 bg-gray-100 dark:bg-slate-700 min-h-[80px] w-screen flex items-center"}>
            ...
            <div className={`w-[90%] md:w-[80%] lg:w-[70%] mx-auto flex justify-between items-center`}>
                ...
                <div className={"flex gap-5 md:gap-10 items-center"}>
                    <button
                        ...
                        className={"text-gray-600 dark:text-gray-300 cursor-pointer transition-all ease-out duration-300 hover:text-sky-500 font-light"}
                    >
                        Compiler
                    </button>
                    ...
                    <button onClick={() => setDropdownCollapsed(!dropdownCollapsed)}
                        ...
                        <div
                            ...
                            className={"text-gray-600 dark:text-gray-300 cursor-pointer transition-all ease-out duration-300 group-hover:text-sky-500 font-light"}
                        >
