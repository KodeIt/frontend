		...
		<PageWrapper className={"gap-5"}>
			...
			<div className={"flex w-full bg-sky-200"}>
				<input
					...
					className={
						"w-full flex-grow rounded-l border-2 border-gray-300 focus:border-sky-500 outline-none p-2 text-gray-600 transition-all ease-out duration-300"
					}
				/>
				<BlueButton onClick={() => {}} filled={true} className={"flex gap-2 rounded-r w-[200px] items-center justify-center"}>
					<SearchRounded />
					<div>Search</div>
				</BlueButton>
			</div>
